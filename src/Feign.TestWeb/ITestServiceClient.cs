...
namespace Feign.TestWeb
{
    ...
    public interface ITestServiceClient
    {
        ...
        ValueTask<IQueryResult<TestServiceParam>> GetQueryResultValueAsync([RequestQuery] string id, [RequestQuery] int[] values, [RequestQuery] Dictionary<string, object>? map, TestServiceParam? param = null);
        [ResultType(typeof(QueryResult<>))]
        [Headers("methodHeader:true")]
